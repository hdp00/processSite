...
[Migration("202608280002_number_counter_prefix_length")]
public sealed class NumberCounterPrefixLengthEfMigration : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ArgumentNullException.ThrowIfNull(migrationBuilder);
        var migration = MigrationCatalog.Migrations.Single(item => item.Id == "202608280002");
