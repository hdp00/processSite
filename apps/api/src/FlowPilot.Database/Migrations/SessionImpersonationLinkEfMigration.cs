...
[Migration("202608280003_session_impersonation_link")]
public sealed class SessionImpersonationLinkEfMigration : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ArgumentNullException.ThrowIfNull(migrationBuilder);
        var migration = MigrationCatalog.Migrations.Single(item => item.Id == "202608280003");
