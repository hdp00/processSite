...
[Migration("202609020002_retained_local_password")]
public sealed class RetainedLocalPasswordEfMigration : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ArgumentNullException.ThrowIfNull(migrationBuilder);
        var migration = MigrationCatalog.Migrations.Single(item => item.Id == "202609020002");
