...
[Migration("202608310001_optional_user_email")]
public sealed class OptionalUserEmailEfMigration : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ArgumentNullException.ThrowIfNull(migrationBuilder);
        var migration = MigrationCatalog.Migrations.Single(item => item.Id == "202608310001");
